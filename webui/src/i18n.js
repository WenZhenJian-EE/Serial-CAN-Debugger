...
export const messages = {
  'zh-CN': {
    ...
    wave: {
      ...
      boxZoom: '框选放大',
      boxZoomTip: '点击激活框选：按住鼠标左键在波形上画矩形，精确放大局部波形细节',
      resetZoom: '复位缩放',
      resetZoomTip: '复位坐标轴缩放与量程视野',
      zoomActiveHint: '局部细节放大中 (数据后台持续缓冲)',
      resumeTrack: '恢复实时跟踪',
      wheelZoomHint: '滚轮: 缩放X轴 | Shift+滚轮: 缩放Y轴 | 拖拽: 平移波形',
      timeBaseLabel: '横轴时基:',
      timeBaseCustom: '自定义秒数',
      timeBaseUnit: '秒',
      yAxisLabel: '纵轴量程:',
      yAxisAuto: '自动量程 (Auto)',
      yAxisManual: '固定量程 (Manual)',
      yAxisCustom: '自定义量程...',
      yAxisMin: 'Min:',
      yAxisMax: 'Max:',
    },
  ...
  'en-US': {
    ...
    wave: {
      ...
      boxZoom: 'Box Zoom',
      boxZoomTip: 'Click and drag a box on chart to zoom in to wave details',
      resetZoom: 'Reset Zoom',
      resetZoomTip: 'Reset timebase and scale to default view',
      zoomActiveHint: 'Detail Zoom Mode (Buffering data in background)',
      resumeTrack: 'Resume Track',
      wheelZoomHint: 'Wheel: Zoom X | Shift+Wheel: Zoom Y | Drag: Pan wave',
      timeBaseLabel: 'Time Base:',
      timeBaseCustom: 'Custom Sec',
      timeBaseUnit: 's',
      yAxisLabel: 'Y Range:',
      yAxisAuto: 'Auto Scale',
      yAxisManual: 'Manual Range',
      yAxisCustom: 'Custom...',
      yAxisMin: 'Min:',
      yAxisMax: 'Max:',
    },
